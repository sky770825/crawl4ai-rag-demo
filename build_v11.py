...
CSS_SRC = os.path.expanduser("~/Desktop/crawl4ai/site_v5.css")
...
sticky_nav = '<a class="skip-link" href="#main">跳至主要內容</a><nav class="sticky-nav"><div class="wrap"><span class="brand">臺灣 RAG</span><button class="nav-toggle" aria-expanded="false" aria-label="切換導航">☰</button><div class="nav-links"><a href="#news">房仲新聞</a><a href="#gov">政府公開</a><a href="#ai">生產力科技</a><a href="#life">生活環保</a></div></div></nav>'
...
<meta name="description" content="從臺灣 23 個公開資料源,自動累積房仲、政府、生產力、生活即時新聞,給老蔡客戶問房時即時查詢。"><meta property="og:title" content="臺灣 RAG — 房仲知識即時查詢"><meta property="og:description" content="從臺灣 23 個公開資料源累積真實新聞"><meta property="og:type" content="website"><link rel="manifest" href="manifest.json"><link rel="icon" href="data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22%3E%3Ctext y=%22.9em%22 font-size=%2290%22%3E📰%3C/text%3E%3C/svg%3E">
