...
sticky_nav = 'sticky_nav = """\n<nav class="sticky-nav" aria-label="主導覽">\n  <div class="wrap">\n    <span class="brand">臺灣 RAG</span>\n    <button class="nav-toggle" aria-expanded="false" aria-label="切換導覽">☰</button>\n    <div class="nav-links">\n      <a href="#news">房仲新聞</a>\n      <a href="#gov">政府公開</a>\n      <a href="#ai">生產力科技</a>\n      <a href="#life">生活環保</a>\n    </div>\n  </div>\n</nav>\n<a class="skip-link" href="#news">跳到主要內容</a>\n"""'
...
<link rel="stylesheet" href="site_v3.css"><meta property="og:title" content="臺灣 RAG">
<meta property="og:description" content="從臺灣 23 個公開資料源累積真實新聞">
